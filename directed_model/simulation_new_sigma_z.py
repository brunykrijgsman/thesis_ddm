...
def prior(nparts):
    ...
    # Low SNR condition: high noise values (truncated normal with high values) 
    # sigma_z_low_SNR = truncated_normal(0.5, 0.2, 0.01, size=nparts)
...
def simul_directed_ddm(ntrials=100, alpha=1, tau=0.4, beta=0.5, eta=0.3, 
                      varsigma=1, mu_z=0, noise_distribution='gaussian', sigma_z=0.2, lambda_param=0.7, b=0.5,
